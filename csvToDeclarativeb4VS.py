...
for line in open(sys.argv[1], 'r'):
		...
		if matchBigipLine:
			...
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service'] = {}
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']['class'] = as3VirtualServerPortMappingDict[matchBigipLine.group('virtualServerPort')]
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']["virtualAddresses"] = [0]
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']["virtualAddresses"][0] = matchBigipLine.group('virtualServerIPAddress')
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']["pool"] = matchBigipLine.group('virtualServerName') + as3PoolAppend
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']["serverTLS"] = matchBigipLine.group('virtualServerName') + as3ClientsslProfileAppend
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']["snat"] = as3VirtualServerSNAT 
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')]['service']["redirect80"] = as3CreateRedirectVSBoolean
			...
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')][ matchBigipLine.group('virtualServerName') + as3PoolAppend ]["members"][0]["serverAddresses"] = [0]
			as3Dict['declaration'][as3AppName][matchBigipLine.group('virtualServerName')][ matchBigipLine.group('virtualServerName') + as3PoolAppend ]["members"][0]["serverAddresses"][0] = matchBigipLine.group('poolMemberAddress1')
